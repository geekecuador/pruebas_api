"""
Django settings for pruebas_api project.
...
SECRET_KEY = 'ks7=_+38#b5e4unz=isp$gm*fhws+qbyi-5nh**$-rnj4y)uo0'
...
WSGI_APPLICATION = 'pruebas_api.wsgi.application'
